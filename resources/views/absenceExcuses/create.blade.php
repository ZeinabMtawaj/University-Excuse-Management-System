        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    @lang('messages.add_new_absence_excuse')
                    <a href="{{ url()->previous() }}" class="btn btn-secondary">@lang('messages.back')</a>
                </div>
                <div class="card-body">

<form method="POST" action="{{ route('absenceExcuses.store') }}" enctype="multipart/form-data">
